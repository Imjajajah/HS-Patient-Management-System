...
@endif
    <div id="patientInfoSection" class="form-section active"></div>
        <form class="jotform-form" onsubmit="" action="/store" method="POST" name="" id="patientInfoForm"
            ...
            <div role="main" class="form-all">  
                <ul class="form-section page-section">
                    ...
                    <button type="button" id="nextToHealthHistory" class="btn btn-primary">Next</button>
            </form>
    


    <div id="healthHistorySection" class="form-section">
        ...
        <form id="healthHistoryForm">
            ...
            <button type="button" id="previousToPatientInfo" class="btn btn-secondary">Previous</button>
            <button type="button" id="nextToInsuranceInfo" class="btn btn-primary">Next</button>
        </form>
    </div>
    <div id="insuranceInfoSection" class="form-section">
                    ...
                    <div id="cid_2" class="form-input-wide" data-layout="full">
                        <div data-align="auto"
                            class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField"><button
                                ...
                                data-component="button" data-content="">Register</button>
                                <button type="button" id="previousToHealthHistory" class="btn btn-secondary">Previous</button></div>
                    </div>
                </li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var healthHistorySection = document.getElementById('healthHistorySection');
            var insuranceInfoSection = document.getElementById('insuranceInfoSection');

            var nextToHealthHistory = document.getElementById('nextToHealthHistory');
            var previousToPatientInfo = document.getElementById('previousToPatientInfo');
            var nextToInsuranceInfo = document.getElementById('nextToInsuranceInfo');
            var previousToHealthHistory = document.getElementById('previousToHealthHistory');

            // Show the Patient Information section by default
            patientInfoSection.classList.add('active');

            // Handle Next button from Patient Info to Health History
            nextToHealthHistory.addEventListener('click', function() {
                patientInfoSection.classList.remove('active');
                healthHistorySection.classList.add('active');
            });

            // Handle Previous button from Health History to Patient Info
            previousToPatientInfo.addEventListener('click', function() {
                healthHistorySection.classList.remove('active');
                patientInfoSection.classList.add('active');
            });

            // Handle Next button from Health History to Insurance Info
            nextToInsuranceInfo.addEventListener('click', function() {
                healthHistorySection.classList.remove('active');
                insuranceInfoSection.classList.add('active');
            });

            // Handle Previous button from Insurance Info to Health History
            previousToHealthHistory.addEventListener('click', function() {
                insuranceInfoSection.classList.remove('active');
                healthHistorySection.classList.add('active');
            });
        });
    </script>
