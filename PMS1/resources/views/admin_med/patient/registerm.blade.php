<script src="{{asset('js/patient_admission.js')}}"></script>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/emergency/store" class="step-form-horizontal" method="POST" id="registrationForm">
                    @csrf
                   ...
                   <!-- Step 4 -->
                    ...
                    <div class="step" id="step5" style="display: none;">
                        <h4>Step 5: Insurance Information</h4>
                        <div class="form-group">
                            <section class="">
                                <div class="row">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="submitBtn" style="display: none;">Register</button>
                    </div>
                </form>
            </div>
        </div>
