...
<body>
    <form class="jotform-form" onsubmit="" action="" method="" name="" id=""
            ...
            <ul class="form-section page-section">
                ...
                <li class="form-line form-line-column form-col-6" data-type="control_email" id="id_281"><label
                    ...
                    <div id="cid_281" class="form-input-wide" data-layout="half"> <input type="email"
                            ...
                            aria-labelledby="label_281" value="" /> </div>
                </li>
                ...
                <li class="form-line form-line-column form-col-4" data-type="control_email" id="id_282"><label
                    ...
                    <div id="cid_282" class="form-input-wide" data-layout="half"> <input type="email"
                            ...
                            size="310" placeholder="e.g. example@example.com" data-component="email"
                            aria-labelledby="label_282" value="" /> </div>
                </li>
                ...
                <li class="form-line" data-type="control_textarea" id="id_255"><label
                    ...
                    <div id="cid_255" class="form-input-wide" data-layout="full">
                        <textarea id="input_255" class="form-textarea" name="q255_additionalNotes" style="width:648px;height:163px"
                ...
                <li class="form-line" data-type="control_textarea" id="id_297"><label
                    ...
                    <div id="cid_297" class="form-input-wide" data-layout="full">
                        <textarea id="input_297" class="form-textarea validate[AlphaNumeric]" name="q297_specify"
                ...
                <li class="form-line" data-type="control_textarea" id="id_332"><label
                    ...
                    <div id="cid_332" class="form-input-wide" data-layout="full">
                        <textarea id="input_332" class="form-textarea validate[AlphaNumeric]" name="q332_specify332"
                ...
                <li class="form-line" data-type="control_textarea" id="id_22"><label
                    ...
                    <div id="cid_22" class="form-input-wide" data-layout="full">
                        <textarea id="input_22" class="form-textarea validate[AlphaNumeric]" name="q22_specifyMedications"
                ...
                <li class="form-line" data-type="control_textarea" id="id_295"><label
                    ...
                    <div id="cid_295" class="form-input-wide" data-layout="full">
                        <textarea id="input_295" class="form-textarea validate[AlphaNumeric]" name="q295_specifyFood"
                ...
                <li class="form-line" data-type="control_textarea" id="id_294"><label
                    ...
                    <div id="cid_294" class="form-input-wide" data-layout="full">
                        <textarea id="input_294" class="form-textarea validate[AlphaNumeric]" name="q294_specifyDrug"
                    ...
                    <div id="cid_321" class="form-input-wide jf-required" data-layout="full">
                        <div class="form-single-column" role="group" aria-labelledby="label_321"
                            data-component="checkbox"><span class="form-checkbox-item" style="clear:left"><span
                                    ...
                                    id="input_321_0" name="q321_familyHistory321[]"
                                    value="Alzheimer&#x27;s Disease" required="" /><label
                                ...
                                style="clear:left"><span class="dragger-item"></span><input type="checkbox"
                                    aria-describedby="label_321" class="form-checkbox validate[required]"
                                    id="input_321_8" name="q321_familyHistory321[]" value="Stroke"
                                    required="" /><label id="label_input_321_8"
                ...
                <li class="form-line form-line-column form-col-1 form-line-column-clear"
                    ...
                    <div id="cid_330" class="form-input-wide" data-layout="full">
                        <textarea id="input_330" class="form-textarea validate[AlphaNumeric]" name="q330_specify331"
                    ...
                    <div id="cid_307" class="form-input-wide" data-layout="full">
                        <div class="form-multiple-column" data-columncount="2" role="group"
                            aria-labelledby="label_307" data-component="radio"><span class="form-radio-item"><span
                                    ...
                                    class="form-radio" id="input_307_0" name="q307_isThe307"
                                    value="Yes" /><label id="label_input_307_0"
                                    for="input_307_0">Yes</label></span><span class="form-radio-item"><span
                                    class="dragger-item"></span><input type="radio" aria-describedby="label_307"
                                    class="form-radio" id="input_307_1" name="q307_isThe307"
                ...
                <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_267">
                    ...
                    <div id="cid_267" class="form-input-wide" data-layout="half"> <input type="text"
                            id="input_267" name="q267_insuranceCompany" data-type="input-textbox"
                ...
                <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="id_268">
                    ...
                    <div id="cid_268" class="form-input-wide" data-layout="half"> <input type="text"
                            id="input_268" name="q268_insuranceId" data-type="input-textbox"
                    ...
                    <div id="cid_309" class="form-input-wide" data-layout="full">
                        <div class="form-single-column" role="group" aria-labelledby="label_309"
                            data-component="radio"><span class="form-radio-item" style="clear:left"><span
                                    ...
                                    class="form-radio" id="input_309_0" name="q309_insurancePlan"
                                ...
                                class="form-radio-item" style="clear:left"><span
                                    class="dragger-item"></span><input type="radio" aria-describedby="label_309"
                                    class="form-radio" id="input_309_1" name="q309_insurancePlan"
                                ...
                                class="form-radio-item" style="clear:left"><span
                                    class="dragger-item"></span><input type="radio" aria-describedby="label_309"
                                    class="form-radio" id="input_309_2" name="q309_insurancePlan"
                                ...
                                class="form-radio-item" style="clear:left"><span
                                    class="dragger-item"></span><input type="radio" aria-describedby="label_309"
                                    class="form-radio" id="input_309_3" name="q309_insurancePlan"
                                ...
                                class="form-radio-item formRadioOther" style="clear:left"><input type="radio"
                                    class="form-radio-other form-radio" name="q309_insurancePlan" id="other_309"
                                    ...
                                    id="other_309_input" class="other-input-container" style="display:none"><input
                                        ...
                                        name="q309_insurancePlan[other]" data-otherhint="Other" size="15"
                ...
                <li class="form-line form-line-column form-col-1 form-line-column-clear"
                    ...
                    <div id="cid_313" class="form-input-wide" data-layout="full">
                        <textarea id="input_313" class="form-textarea validate[AlphaNumeric]" name="q313_specify313"
                ...
                <li class="form-line form-line-column form-col-2" data-type="control_fullname" id="id_269"
                    ...
                    <div id="cid_269" class="form-input-wide" data-layout="full">
                        <div data-wrapper-react="true"><span class="form-sub-label-container"
                                style="vertical-align:top" data-input-type="first"><input type="text"
                                    id="first_269" name="q269_cardHolders269[first]" class="form-textbox"
                                    data-defaultvalue="" autoComplete="section-input_269 given-name"
                                    size="10" placeholder="First Name" data-component="first"
                                    aria-labelledby="label_269" value="" /></span><span
                                class="form-sub-label-container" style="vertical-align:top"
                                data-input-type="last"><input type="text" id="last_269"
                                    name="q269_cardHolders269[last]" class="form-textbox" data-defaultvalue=""
                ...
                <li class="form-line form-line-column form-col-3" data-type="control_datetime" id="id_270">
                    ...
                    <div id="cid_270" class="form-input-wide" data-layout="half">
                        <div data-wrapper-react="true">
                            <div style="display:none"><span class="form-sub-label-container"
                                    style="vertical-align:top"><input type="tel"
                                        class="form-textbox validate[limitDate]" id="month_270"
                                        name="q270_dateOf308[month]" size="2" data-maxlength="2"
                                        data-age="" maxLength="2" value="" autoComplete="off"
                                        aria-labelledby="label_270 sublabel_270_month" /><span class="date-separate"
                                        aria-hidden="true"> /</span><label class="form-sub-label" for="month_270"
                                        id="sublabel_270_month" style="min-height:13px">Month</label></span><span
                                    class="form-sub-label-container" style="vertical-align:top"><input
                                        type="tel" class="form-textbox validate[limitDate]" id="day_270"
                                        name="q270_dateOf308[day]" size="2" data-maxlength="2"
                                        data-age="" maxLength="2" value="" autoComplete="off"
                                    ...
                                    class="form-sub-label-container" style="vertical-align:top"><input
                                        type="tel" class="form-textbox validate[limitDate]" id="year_270"
                                        name="q270_dateOf308[year]" size="4" data-maxlength="4"
                                        data-age="" maxLength="4" value="" autoComplete="off"
                                        aria-labelledby="label_270 sublabel_270_year" /><label
                                        class="form-sub-label" for="year_270" id="sublabel_270_year"
                                        style="min-height:13px">Year</label></span></div><span
                                class="form-sub-label-container" style="vertical-align:top"><input type="text"
                                    class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_270"
                                    size="12" data-maxlength="12" maxLength="12" data-age=""
                                    value="" data-format="mmddyyyy" data-seperator="/"
                                    placeholder="MM/DD/YYYY" data-placeholder="MM/DD/YYYY" autoComplete="off"
                                    aria-labelledby="label_270" /><img
                                    class="showAutoCalendar newDefaultTheme-dateIcon icon-liteMode"
                ...
                <li class="form-line form-line-column form-col-5" data-type="control_email" id="id_320"><label
                    ...
                    <div id="cid_320" class="form-input-wide" data-layout="half"> <input type="email"
                            id="input_320" name="q320_cardHolders320" class="form-textbox validate[Email]"
                            data-defaultvalue="" autoComplete="section-input_320 email" style="width:310px"
                            size="310" placeholder="e.g. example@example.com" data-component="email"
                            aria-labelledby="label_320" value="" /> </div>
                </li>
                            ...
                            <div class="form-address-line-wrapper jsTest-address-line-wrapperField"><span
                                    class="form-address-line form-address-street-line jsTest-address-lineField"><span
                                        class="form-sub-label-container" style="vertical-align:top"><input
                                            ...
                                            placeholder="Street Address" data-component="address_line_1"
                                            aria-labelledby="label_316" value="" /></span></span></div>
                            <div class="form-address-line-wrapper jsTest-address-line-wrapperField"><span
                                    class="form-address-line form-address-street-line jsTest-address-lineField"><span
                                        class="form-sub-label-container" style="vertical-align:top"><input
